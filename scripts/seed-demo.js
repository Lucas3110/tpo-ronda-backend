...
const USUARIOS = [
  { email: 'admin@ronda.com', nombre: 'Admin Ronda', telefono: '11 0000-0000', zona: 'Palermo' },
...
const PUBLICACIONES = [
  { v: 1, titulo: 'iPhone 12 64GB', descripcion: 'Impecable, batería 89%. Incluye caja y cargador original. Sin detalles en la pantalla.', cat: 'Celulares', precio: 320000, est: 'COMO_NUEVO', zona: 'Palermo', fotos: 3 },
  { v: 1, titulo: 'Notebook Lenovo IdeaPad', descripcion: 'Ryzen 5, 16GB de RAM, SSD 512GB. Ideal para estudiar o trabajar. Poco uso.', cat: 'Computación', precio: 540000, est: 'USADO', zona: 'Palermo', fotos: 2 },
  { v: 1, titulo: 'Bicicleta rodado 29', descripcion: 'Mountain bike aluminio, 21 velocidades. Recién service completo.', cat: 'Deportes', precio: 185000, est: 'USADO', zona: 'Palermo', fotos: 4 },
  { v: 2, titulo: 'PlayStation 5 Slim', descripcion: 'Sellada, sin abrir. Modelo con lectora. Garantía oficial.', cat: 'Consolas y videojuegos', precio: 890000, est: 'NUEVO', zona: 'Quilmes', fotos: 2 },
  { v: 2, titulo: 'Heladera Whirlpool no frost', descripcion: 'Funciona perfecto, la vendo por mudanza. 375 litros.', cat: 'Electrodomésticos', precio: 410000, est: 'USADO', zona: 'Quilmes', fotos: 3 },
  { v: 2, titulo: 'Taladro percutor Black+Decker', descripcion: 'Con maletín y set de mechas. Usado dos veces.', cat: 'Herramientas', precio: 65000, est: 'COMO_NUEVO', zona: 'Quilmes', fotos: 1 },
  { v: 3, titulo: 'Guitarra criolla La Alpujarra', descripcion: 'Modelo 300, tapa de cedro. Sonido muy dulce. Incluye funda.', cat: 'Instrumentos musicales', precio: 145000, est: 'USADO', zona: 'Villa Urquiza', fotos: 2 },
  { v: 3, titulo: 'Sillón de dos cuerpos', descripcion: 'Tapizado en chenille gris. Muy cómodo, sin manchas ni roturas.', cat: 'Hogar y muebles', precio: 230000, est: 'USADO', zona: 'Villa Urquiza', fotos: 3 },
  { v: 3, titulo: 'Cochecito Bebesit 3 en 1', descripcion: 'Incluye huevito y base para auto. Usado por un solo bebé.', cat: 'Bebés', precio: 120000, est: 'COMO_NUEVO', zona: 'Villa Urquiza', fotos: 2 },
  { v: 1, titulo: 'Colección Harry Potter', descripcion: 'Los 7 libros, tapa dura, edición Salamandra. En muy buen estado.', cat: 'Libros', precio: 85000, est: 'USADO', zona: 'Palermo', fotos: 1 },
  { v: 2, titulo: 'Campera de cuero talle M', descripcion: 'Cuero legítimo, color negro. Usada pocas veces.', cat: 'Indumentaria', precio: 95000, est: 'COMO_NUEVO', zona: 'Quilmes', fotos: 2 },
  { v: 3, titulo: 'Monitor Samsung 24" curvo', descripcion: 'Full HD, 75Hz. Sin píxeles muertos. Incluye cables.', cat: 'Computación', precio: 175000, est: 'USADO', zona: 'Villa Urquiza', fotos: 2 },
];
